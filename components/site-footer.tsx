    ...
    <footer className="border-t bg-muted/40">
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div>
            <h3 className="text-sm font-medium">Belanja</h3>
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>
                <Link href="/products?sort=price-asc" className="text-muted-foreground hover:text-foreground">
                  Harga Termurah
                </Link>
              </li>
              <li>
                <Link href="/products?sort=price-desc" className="text-muted-foreground hover:text-foreground">
                  Harga Tertinggi
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-sm font-medium">Hubungi Kami</h3>
            <ul className="mt-4 space-y-2 text-sm">
              <li className="text-muted-foreground">
                Jl. Contoh No. 123, Kota Contoh
              </li>
              <li className="text-muted-foreground">
                Email: info@luxemarket.com
              </li>
              <li className="text-muted-foreground">
        ...
        <div className="mt-8 border-t pt-8 md:flex md:items-center md:justify-between">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} LuxeMarket. Hak Cipta Dilindungi.
          </p>
